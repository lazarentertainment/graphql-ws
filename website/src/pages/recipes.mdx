...
## [ws](https://github.com/websockets/ws) server usage with async iterator error recovery

See the unit tests for an example of the output of using this approach to error handling.
